...
export function RosterRegisterForm({ communitySlug, communityName }: Props) {
              ...
              <div className="flex max-h-48 flex-wrap gap-2 overflow-y-auto">
                ...
                {roster.map((r) => (
                  <button
                    ...
                    className={cn(
                      "min-h-[44px] rounded-full px-4 text-sm font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent",
                      selectedId === r.id
